...
function Signup(props: SignupProps) {
    ...
    const helperMsg = " Pasword must contain 1 number, 1 uppercase character, 1 lowercase character and be 8 characters or more."
                        ...
                        <Form>
                            ...
                            <Field name="firstName" validate={validateFirstName}>
                                ...
                                <FormControl isInvalid={form.errors.firstName && form.touched.firstName}>
                                    ...
                                    <Input {...field} variant="outline" placeholder="First Name" isRequired/>
                            ...
                            <Field name="lastName" validate={validateLastName}>
                                {({field, form} : any) => (
                                    <FormControl isInvalid={form.errors.lastName && form.touched.lastName}> 
                                        ...
                                        <Input {...field} variant="outline" placeholder="Last Name"/>
                            ...
                            <RedButton size="md" type="submit">Sign up</RedButton>
                            </Stack>
                        </Form>
                    </Formik>
                </ModalBody>
